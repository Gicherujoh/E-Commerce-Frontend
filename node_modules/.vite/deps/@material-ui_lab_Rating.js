import {
  require_react_dom
} from "./chunk-MVRVJCLU.js";
import {
  _extends,
  _inheritsLoose,
  _objectWithoutPropertiesLoose
} from "./chunk-TFJG5XNE.js";
import {
  require_prop_types,
  require_react_is
} from "./chunk-BKXWKO5P.js";
import {
  require_react
} from "./chunk-BUV7HO6G.js";
import {
  __commonJS,
  __toESM
...
function isClassComponent(elementType3) {
  var _elementType$prototyp = elementType3.prototype, prototype = _elementType$prototyp === void 0 ? {} : _elementType$prototyp;
...
function acceptingRef(props, propName, componentName, location, propFullName) {
  ...
  var warningHint;
  var elementType3 = element.type;
  if (typeof elementType3 === "function" && !isClassComponent(elementType3)) {
...
function isClassComponent2(elementType3) {
  var _elementType$prototyp = elementType3.prototype, prototype = _elementType$prototyp === void 0 ? {} : _elementType$prototyp;
  return Boolean(prototype.isReactComponent);
}
...
function isClassComponent3(elementType3) {
  var _elementType$prototyp = elementType3.prototype, prototype = _elementType$prototyp === void 0 ? {} : _elementType$prototyp;
  return Boolean(prototype.isReactComponent);
}
function acceptingRef2(props, propName, componentName, location, propFullName) {
  ...
  var warningHint;
  var elementType3 = element.type;
  if (typeof elementType3 === "function" && !isClassComponent3(elementType3)) {
    warningHint = "Did you accidentally use a plain function component for an element instead?";
  }
  if (warningHint !== void 0) {
    return new Error("Invalid ".concat(location, " `").concat(safePropName, "` supplied to `").concat(componentName, "`. ") + "Expected an element that can hold a ref. ".concat(warningHint, " ") + "For more information see https://mui.com/r/caveat-with-refs-guide");
...
var elementAcceptingRef2 = chainPropTypes2(import_prop_types3.default.element, acceptingRef2);
elementAcceptingRef2.isRequired = chainPropTypes2(import_prop_types3.default.element.isRequired, acceptingRef2);
...
function isClassComponent4(elementType3) {
  var _elementType$prototyp = elementType3.prototype, prototype = _elementType$prototyp === void 0 ? {} : _elementType$prototyp;
  return Boolean(prototype.isReactComponent);
}
...
var elementTypeAcceptingRef_default2 = chainPropTypes2(PropTypes5.elementType, elementTypeAcceptingRef2);
...
var refType2 = import_prop_types4.default.oneOfType([import_prop_types4.default.func, import_prop_types4.default.object]);
...
function decomposeColor(color2) {
  ...
  if (["rgb", "rgba", "hsl", "hsla"].indexOf(type) === -1) {
    throw new Error(true ? "Material-UI: Unsupported `".concat(color2, "` color.\nWe support the following formats: #nnn, #nnnnnn, rgb(), rgba(), hsl(), hsla().") : formatMuiErrorMessage2(3, color2));
  }
...
function createPalette(palette2) {
  ...
  var augmentColor = function augmentColor2(color2) {
    ...
    if (!color2.main) {
      throw new Error(true ? "Material-UI: The color provided to augmentColor(color) is invalid.\nThe color object needs to have a `main` property or a `".concat(mainShade, "` property.") : formatMuiErrorMessage2(4, mainShade));
    }
    if (typeof color2.main !== "string") {
      throw new Error(true ? "Material-UI: The color provided to augmentColor(color) is invalid.\n`color.main` should be a string, but `".concat(JSON.stringify(color2.main), '` was provided instead.\n\nDid you intend to use one of the following approaches?\n\nimport { green } from "@material-ui/core/colors";\n\nconst theme1 = createTheme({ palette: {\n  primary: green,\n} });\n\nconst theme2 = createTheme({ palette: {\n  primary: { main: green[500] },\n} });') : formatMuiErrorMessage2(5, JSON.stringify(color2.main)));
    }
  ...
  var paletteOutput = deepmerge2(_extends({
...
function compose() {
  ...
  var fn = function fn2(props) {
    return styles5.reduce(function(acc, style2) {
  ...
  fn.propTypes = true ? styles5.reduce(function(acc, style2) {
    return _extends(acc, style2.propTypes);
  }, {}) : {};
  fn.filterProps = styles5.reduce(function(acc, style2) {
...
function mergeClasses() {
  ...
  if (true) {
    if (typeof newClasses === "string") {
      console.error(["Material-UI: The value `".concat(newClasses, "` ") + "provided to the classes prop of ".concat(getDisplayName2(Component), " is incorrect."), "You might want to use the className prop instead."].join("\n"));
      return baseClasses;
    }
  }
  Object.keys(newClasses).forEach(function(key) {
    if (true) {
      if (!baseClasses[key] && newClasses[key]) {
        console.error(["Material-UI: The key `".concat(key, "` ") + "provided to the classes prop is not implemented in ".concat(getDisplayName2(Component), "."), "You can only override one of the following: ".concat(Object.keys(baseClasses).join(","), ".")].join("\n"));
      }
      if (newClasses[key] && typeof newClasses[key] !== "string") {
        console.error(["Material-UI: The key `".concat(key, "` ") + "provided to the classes prop is not valid for ".concat(getDisplayName2(Component), "."), "You need to provide a non empty string instead of: ".concat(newClasses[key], ".")].join("\n"));
      }
    }
    if (newClasses[key]) {
...
if (true) {
  true ? StylesProvider.propTypes = exactProp2(StylesProvider.propTypes) : void 0;
}
  ...
  return {
    create: function create2(theme, name) {
      ...
      Object.keys(overrides).forEach(function(key) {
        ...
        stylesWithOverrides[key] = deepmerge2(stylesWithOverrides[key], overrides[key]);
      });
...
var withStyles = function withStyles2(stylesOrCreator) {
  ...
  return function(Component) {
    ...
    if (true) {
      if (!name) {
        var displayName = getDisplayName2(Component);
    ...
    true ? WithStyles.propTypes = {
       ...
       * @deprecated
       */
      innerRef: chainPropTypes2(import_prop_types11.default.oneOfType([import_prop_types11.default.func, import_prop_types11.default.object]), function(props) {
    ...
    if (true) {
      WithStyles.displayName = "WithStyles(".concat(getDisplayName2(Component), ")");
    }
...
function withThemeCreator() {
  ...
  var withTheme3 = function withTheme4(Component) {
    ...
    true ? WithTheme.propTypes = {
       ...
       * @deprecated
       */
      innerRef: chainPropTypes2(import_prop_types12.default.oneOfType([import_prop_types12.default.func, import_prop_types12.default.object]), function(props) {
        if (props.innerRef == null) {
          return null;
        }
    ...
    if (true) {
      WithTheme.displayName = "WithTheme(".concat(getDisplayName2(Component), ")");
    }
...
if (typeof window !== "undefined") {
  ponyfillGlobal_default2["__@material-ui/styles-init__"] = ponyfillGlobal_default2["__@material-ui/styles-init__"] || 0;
  if (ponyfillGlobal_default2["__@material-ui/styles-init__"] === 1) {
  ...
  ponyfillGlobal_default2["__@material-ui/styles-init__"] += 1;
}
...
function capitalize(string) {
  if (typeof string !== "string") {
    throw new Error(true ? "Material-UI: capitalize(string) expects a string argument." : formatMuiErrorMessage2(7));
  }
...
true ? SvgIcon.propTypes = {
   ...
   */
  color: import_prop_types13.default.oneOf(["action", "disabled", "error", "inherit", "primary", "secondary"]),
  /**
   ...
   */
  fontSize: chainPropTypes2(import_prop_types13.default.oneOf(["default", "inherit", "large", "medium", "small"]), function(props) {
...
function createSvgIcon(path, displayName) {
  ...
  return import_react11.default.memo(import_react11.default.forwardRef(Component));
}
...
var Star_default = createSvgIcon(React19.createElement("path", {
...
function IconContainer(props) {
  ...
  return React20.createElement("span", other);
}
true ? IconContainer.propTypes = {
  value: import_prop_types14.default.number.isRequired
} : void 0;
var defaultIcon = React20.createElement(Star_default, {
  fontSize: "inherit"
});
function defaultLabelText(value) {
  return "".concat(value, " Star").concat(value !== 1 ? "s" : "");
}
var Rating = React20.forwardRef(function Rating2(props, ref) {
  ...
  var _React$useState2 = React20.useState(false), focusVisible = _React$useState2[0], setFocusVisible = _React$useState2[1];
  var rootRef = React20.useRef();
  ...
  var handleMouseMove = function handleMouseMove2(event) {
    ...
    if (theme.direction === "rtl") {
      percent2 = (right2 - event.clientX) / (width2 * max);
    } else {
      percent2 = (event.clientX - left2) / (width2 * max);
    }
    var newHover = roundValueToPrecision(max * percent2 + precision / 2, precision);
  ...
  var item = function item2(state, labelProps) {
    ...
    var container = React20.createElement(IconContainerComponent, {
      value: state.value,
    ...
    return React20.createElement(React20.Fragment, {
      key: state.value
    }, React20.createElement("label", _extends({
      className: classes.label,
      htmlFor: id
    }, labelProps), container, React20.createElement("span", {
      className: classes.visuallyhidden
    }, getLabelText(state.value))), React20.createElement("input", {
      onFocus: handleFocus,
      onBlur: handleBlur,
  ...
  }, other), Array.from(new Array(max)).map(function(_, index2) {
    var itemValue = index2 + 1;
    if (precision < 1) {
  ...
  }), !readOnly && !disabled && valueRounded == null && React20.createElement(React20.Fragment, null, React20.createElement("input", {
    value: "",
...
true ? Rating.propTypes = {
   ...
   */
  name: chainPropTypes(import_prop_types14.default.string, function(props) {
   ...
   */
  precision: chainPropTypes(import_prop_types14.default.number, function(props) {
...
var Rating_default = withStyles_default2(styles3, {
  name: "MuiRating"
})(Rating);
export {
